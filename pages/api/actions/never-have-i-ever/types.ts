...
export interface IGetChallengeByID {
 ...
 // Add any additional valid action types here

export interface LinkedAction {
     // Use the newly defined type
    label: string;
    href: string;
    parameters: any[];
  }
...
export interface NeverHaveIEverResponse {
    question1: string;  // Answer to the first question (I Have / I Have Never)
    question2: string;  // Answer to the second question (I Have / I Have Never)
    walletPublicKey: string;  // User's Wallet Public Key
  }
  
  // New interface for storing the vote/answers in the backend
  export interface SubmitNeverHaveIEver {
    walletPublicKey: string;  // User's Wallet Public Key
    question1Answer: string;  // Answer to the first question
    question2Answer: string;  // Answer to the second question
  }
